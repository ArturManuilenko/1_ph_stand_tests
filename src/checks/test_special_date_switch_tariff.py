...
from src.fixtures.test_special_date_switch_fixture import irreg_date, reg_date, options_sp_date

logger = logging.getLogger(__name__)


def test_special_date_switch_tariff(
    ...
    logger.info('CHECK SPECIAL DATE TARIF SWITCHING')
    ...
    try:
        ...
        for dt in irreg_date:
            ...
            wait.wait(8500)  # иначе возникает ошибка err_need_wait
